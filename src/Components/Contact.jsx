...
// import { FaPhoneAlt, FaEnvelope, FaMapMarkerAlt, FaGithub, FaLinkedin, FaInstagram, FaWhatsapp } from "react-icons/fa";
...
//           <span className="text-gray-700">+91 6283171987</span>
//         </a>
//         <a className="flex items-center space-x-3 cursor-pointer" href="mailto:puneet02ujar@gmail.com">
//           <FaEnvelope className="text-xl" />
//           <span className="text-gray-700">puneet02ujar@gmail.com</span>
//         </a>
//       </div>
